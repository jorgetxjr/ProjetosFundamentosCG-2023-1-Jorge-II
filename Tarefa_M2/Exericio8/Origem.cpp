...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		...
		//x    y    z    r    g    b
		-0.5, 0.5, -0.5, 0.0, 0.0, 0.0,//superior esquerdo
		-0.5, 0.5,  0.5, 0.0, 0.0, 0.0,//inferior esquerdo
		 0.5, 0.5, -0.5, 0.0, 0.0, 0.0,//superior direito

		 -0.5, 0.5, 0.5, 0.0, 0.0, 0.0,//inferior esquerdo
		  0.5, 0.5,  0.5, 0.0, 0.0, 0.0,//inferior direito
		  0.5, 0.5, -0.5, 0.0, 0.0, 0.0,//superior direito
		  
		  //face 1 - chapado na tela
		 //x     y     z    r    g    b
		 -0.5, -0.5, -0.5, 1.0, 0.0, 0.0,//inferior esquerdo
		  0.5,  0.5,  -0.5, 1.0, 0.0, 0.0,//superior "centro", deslocado para a direita
		  0.5, -0.5, -0.5, 1.0, 0.0, 0.0,//inferior direito
		  ...
		  //face2
		  //x     y     z    r    g    b
		  -0.5,  0.5,  -0.5, 0.0, 1.0, 0.0,//p2
		  -0.5, -0.5, -0.5, 0.0, 1.0, 0.0,//p1
		  -0.5, -0.5, 0.5, 0.0, 1.0, 0.0,//p3

		  -0.5, 0.5, 0.5, 0.0, 1.0, 0.0,//p6
		  -0.5,  0.5,  -0.5, 0.0, 1.0, 0.0,//p5
		  -0.5, -0.5, 0.5, 0.0, 1.0, 0.0,//p4



		  //face 3
		  //x     y     z    r    g    b
		   -0.5, -0.5, 0.5, 1.0, 1.0, 0.0,//p1
		  -0.5,  0.5,  0.5, 1.0, 1.0, 0.0,//p2
		  0.5, -0.5, 0.5, 1.0, 1.0, 0.0,//p3

		  //x     y     z    r    g    b
		   0.5, 0.5, 0.5, 1.0, 1.0, 0.0,//p4
		  -0.5,  0.5,  0.5, 1.0, 1.0, 0.0,//p5
		  0.5, -0.5, 0.5, 1.0, 1.0, 0.0,//p6
		  

		  //face 4
		  //x     y     z    r    g    b
		  0.5, -0.5, 0.5, 0.0, 0.0, 1.0,//p1
		  0.5,  0.5,  0.5, 0.0, 0.0, 1.0,//p2
		  0.5, -0.5, -0.5, 0.0, 0.0, 1.0,//p3

		  //x     y     z    r    g    b
		  0.5,  0.5, -0.5, 0.0, 0.0, 1.0,//p4
		  0.5,  0.5,  0.5, 0.0, 0.0, 1.0,//p5
		  0.5, -0.5, -0.5, 0.0, 0.0, 1.0,//p6
