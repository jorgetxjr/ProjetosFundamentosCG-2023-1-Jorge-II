...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola cubo girante - Jorge JR!", nullptr, nullptr);
	...
	//string nomeTextura = "Suzanne.png";
	string nomeTextura = "cube.png";
	GLuint texID = loadTexture(nomeTextura);

	// Gerando uma geometria de quadrilátero com coordenadas de textura
	int nVerts;
	//string caminhoObj = "SuzanneTriTextured.obj";
	string caminhoObj = "cube.obj";
	GLuint VAO = loadSimpleOBJ(caminhoObj, nVerts,glm::vec3(0,0,0));
